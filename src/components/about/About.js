    ...
    <div>
      ...
      <div className="teamContainer">
        <div className="teamCard">
          ...
          <a href="https://linkedin.com/in/evan-woodworth"><LinkedInIcon/></a>
          <a href="https://github.com/evan-woodworth"><GitHubIcon/></a>
          <img src="/img/evan-profile-pic.jpeg" alt="profile" />
        </div>
        <div className="teamCard">
          <p className="teamTitle">Cameron Walden</p>
          <a href="https://www.linkedin.com/in/cameronwalden/"><LinkedInIcon/></a>
          <a href="https://github.com/Cameron-Walden"><GitHubIcon/></a>
          <img src="/img/cameron-profile-pic.jpeg" alt="profile" />
        </div>
        <div className="teamCard">
          <p className="teamTitle">Antoine Charette</p>
          <a href="https://www.linkedin.com/in/antoinecharette/"><LinkedInIcon/></a>
          <a href="https://github.com/DevAOC"><GitHubIcon/></a>
          <img src="/img/antoine.jpeg" alt="profile" />
        </div>
        <div className="teamCard">
          <p className="teamTitle">George Mead</p>
          <a href="https://www.linkedin.com/in/george-mead/"><LinkedInIcon/></a>
          <a href="https://github.com/gmeadiv"><GitHubIcon/></a>
